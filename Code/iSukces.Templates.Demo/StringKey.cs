...
public sealed class MyIdentifierSystemTextJsonConverter : System.Text.Json.Serialization.JsonConverter<MyIdentifier>
{
    public override MyIdentifier Read(ref System.Text.Json.Utf8JsonReader reader, Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
    {
        return new MyIdentifier(reader.GetString());
    }

    public override void Write(System.Text.Json.Utf8JsonWriter writer, MyIdentifier value, System.Text.Json.JsonSerializerOptions options)
    {
