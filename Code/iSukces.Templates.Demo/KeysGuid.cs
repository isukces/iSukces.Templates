// This file was generated by iSukces.Templates ver 1.25.1210.8
...
public readonly record struct MyUid(Guid Value): IComparable, IComparable<Guid>, IComparable<MyUid>, IEquatable<Guid>, IEquatable<MyUid>, IPrimitiveWrapper<Guid>
{
    ...
    public int CompareTo(object? obj)
    {
        ...
        return obj is MyUid other
            ? CompareTo(other)
            : throw new ArgumentException($"Object must be of type {nameof(MyUid)}");
    }
...
public sealed class MyUidSystemTextJsonConverter : System.Text.Json.Serialization.JsonConverter<MyUid>
{
    public override MyUid Read(ref System.Text.Json.Utf8JsonReader reader, Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
    {
        return MyUid.Parse(reader.GetString()!);
    }

    public override void Write(System.Text.Json.Utf8JsonWriter writer, MyUid value, System.Text.Json.JsonSerializerOptions options)
    {
