...
public sealed class TemperatureSystemTextJsonConverter : System.Text.Json.Serialization.JsonConverter<Temperature>
{
    public override Temperature Read(ref System.Text.Json.Utf8JsonReader reader, Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
    {
        return Temperature.Parse(reader.GetString()!);
    }

    public override void Write(System.Text.Json.Utf8JsonWriter writer, Temperature value, System.Text.Json.JsonSerializerOptions options)
    {
